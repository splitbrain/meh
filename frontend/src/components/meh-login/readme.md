...
| `customTranslations` | `custom-translations` | Custom translations object that overrides default and loaded translations This allows users to provide their own translations directly | `string \| { login?: string; logout?: string; password?: string; submit?: string; loginError?: string; nopass?: string; noadmin?: string; badpass?: string; }` | `''`    |
